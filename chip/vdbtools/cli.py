...
@click.option('--clobber', '-f', is_flag=True, show_default=True, default=False, required=True, help="If exists, delete existing duckdb file and then start from scratch")
@click.option('--db', '-i', 'database', type=click.Path(), required=True, help="The duckdb database to import the caller data")
...
@click.option('--header-type', '-t', type=click.STRING, default=None, help="A pre-existing header type e.g. simple, mutect, vardict, complex, etc.")
